...
global.owner = process.env.OWNER_NUMBER  || '2349068322194' ;  // ADD YOUR NUMBER WITHOUT +
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '03_06_2024_SIGMA_MD_vTkhUqrA_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
