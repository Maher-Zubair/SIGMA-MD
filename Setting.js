...
global.owner = process.env.OWNER_NUMBER  || '2347031165447' ;  // ADD YOUR NUMBER WITHOUT +
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || 10_06_2024_SIGMA_MD_cNuT1dT5_MAHER_ZUBAIR'',              // PUT YOUR SESSION ID
