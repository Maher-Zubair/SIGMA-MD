...
global.owner = process.env.OWNER_NUMBER  || '94779519998' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "94779519998" ;          // DON'T REMOVE
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'yasiru',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `yasiru`, // ADD YOUR NAME
