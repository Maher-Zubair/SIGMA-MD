...
global.owner = process.env.OWNER_NUMBER  || '254748832009' ;  // ADD YOUR NUMBER WITHOUT +
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '01_05_2024_SIGMA_MD_SwNbKGiB_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
